...
$(document).ready(() => {
    const links = [{
            name: 'Cheddlatron',
            link: 'https://github.com/Cheddlatron',
        },
        {
            name: 'Cheaper Nitro',
            link: 'https://roze.lol/cheddlar',
        },
        {
            name: 'CheddShop',
            link: 'https://cheddshop.sellpass.io',
        },
        {
            name: 'LightningBot',
        ...
        {
            name: 'Steam Profile',
            link: 'https://steamcommunity.com/id/Cheddlar/',
        },
    ];
...
$.getJSON(ipgeolocation, (data) => {
    writeLine(['https://ched.rip/authenticating...', "Granting access to <span style='font-size: 14px; color: #e87aff;'>[Paradise]</span>..."], 30, () => {
        ...
        writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
            ...
            writeLine([`<i style='color: #F62459'>ched.rip ☭♛⛧</i>`], 120, 500, () => {
                timeouts.push(
                    setTimeout(() => {
                        if (app.skippedIntro) return;
